...
def init_pgbench(pg_bin_dir, conn_details, scale):
...
def main():
    ...
    try:
        ...
        if not args.skip_pgbench_init:
            ...
            init_pgbench(MASTER_BIN, MASTER_CONN_DETAILS, args.pgbench_scale)
            ...
            init_pgbench(PATCH_BIN, PATCH_CONN_DETAILS, args.pgbench_scale)
