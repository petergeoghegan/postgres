...
-- Index definition is per the paper:
...
----------------------------------------------
-- Patch performance (with prewarmed cache) --
----------------------------------------------
...
pg@regression:5432 [2574594]=# set skipscan_prefix_cols = 1;
SET
...
pg@regression:5432 [2574594]=# set skipscan_prefix_cols = 0;
SET
pg@regression:5432 [2574594]=# EXPLAIN (ANALYZE, WAL, VERBOSE, SUMMARY, BUFFERS, SERIALIZE)
select
  dept,
