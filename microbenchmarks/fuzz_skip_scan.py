...
class PostgreSQLSkipScanTester:
    ...
    def generate_random_where_clause(self):
        ...
        return " AND ".join(all_conditions) + (" ORDER BY a, b, c, d" if random.random() < 0.50 else
...
if __name__ == "__main__":
    ...
    tester = PostgreSQLSkipScanTester(
        ...
        num_tests=50_000, # Number of test queries
        report_interval=10 # Report progress each time this many queries run
    )
