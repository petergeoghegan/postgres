				...
				IndexScanDesc scandesc)
{
	 ...
	 * may still lay the tuple out differently, at least in certain edge cases
	 * involving polymorphic types. (Actually, btree's "name" opclass stores
	 * tuples that aren't binary compatible in the strictest sense.  We handle
