...
static int	_bt_num_array_keys(IndexScanDesc scan, BTSkipPreproc *skipatts,
...
_bt_preprocess_array_keys(IndexScanDesc scan, int *new_numberOfKeys)
{
	 ...
	 */
	numArrayKeys = _bt_num_array_keys(scan, skipatts, &numSkipArrayKeys);
 ...
 */
static int
_bt_num_array_keys(IndexScanDesc scan, BTSkipPreproc *skipatts,
				   int *numSkipArrayKeys)
{
	Relation	rel = scan->indexRelation;
