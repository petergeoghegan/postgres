 ...
 * told us were killed.
 *
 * The batch parameter contains information about the page and killed tuples
 * thereon (this should only be called if batch->numKilled > 0).
 *
 ...
 * on overflow buffer, as indicated by BufferIsValid(batch->buf).
 *
