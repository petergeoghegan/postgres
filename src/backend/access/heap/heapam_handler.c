 ...
 *
 * Called when caller's current scanBatch (passed to us as priorBatch) has no
 * more matching items in the given scan direction.  Caller passes a NULL
 ...
 * is also responsible for advancing their scanPos position.
 */
