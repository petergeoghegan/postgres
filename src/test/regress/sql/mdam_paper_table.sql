...
-- With the optimization enabled we get 2 index searches and 12 buffer hits:
--
-- At one point we saw 3 index searches and 14
-- buffer hits (fixed by not resetting the arrays after checking the high key
-- in _bt_readpage when pstate.forcenonrequired was set):
