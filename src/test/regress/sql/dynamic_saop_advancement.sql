...
--
-- This decision was based on the fact that one of the later row compare
-- queries would fail a newly added assertion verifying agreement between input and
...
-- this test.  (The other factor was the total lack of evidence that having
-- independent coverage for default fillfactor=90 had any independent
-- benefit.)
set client_min_messages=error;
...
-- at runtime) alongside RowCompareExpr:
