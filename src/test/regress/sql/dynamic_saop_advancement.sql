...
-------------------------------------------------------------------------
-- Confusion about nonexistent leftmost value zero for thousand column --
-------------------------------------------------------------------------
...
set enable_indexonlyscan to off;
set enable_indexscan to off;
prepare leftmost_page_nozero_confusion as
with a as (
...
execute leftmost_page_nozero_confusion;
EXPLAIN (ANALYZE, BUFFERS, TIMING OFF, SUMMARY OFF)
execute leftmost_page_nozero_confusion;
deallocate leftmost_page_nozero_confusion;
...
set statement_timeout to '5s'; -- strictly necessary for master
