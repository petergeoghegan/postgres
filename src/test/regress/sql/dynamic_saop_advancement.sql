...
-- (August 21) Infinite loop binary-search-arary-keys bug test case:
...
--
-- This stresses "binary search for array keys" logic
prepare avoid_planner_hits as
with a as (
...
-- implementation:
insert into tenk1_dyn_saop
select unique1, unique2, 4999, four, ten, twenty, hundred, thousand, twothousand, fivethous, tenthous, odd, even, stringu1, stringu2, string4
from
  tenk1_dyn_saop
limit 1 offset 0;
insert into tenk1_dyn_saop
select unique1, unique2, 5000, four, ten, twenty, hundred, thousand, twothousand, fivethous, tenthous, odd, even, stringu1, stringu2, string4
from
  tenk1_dyn_saop
limit 1 offset 1;
insert into tenk1_dyn_saop
select unique1, unique2, 5001, four, ten, twenty, hundred, thousand, twothousand, fivethous, tenthous, odd, even, stringu1, stringu2, string4
from
  tenk1_dyn_saop
limit 1 offset 2;
execute avoid_planner_hits;
