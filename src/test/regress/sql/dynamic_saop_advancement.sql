...
EXPLAIN (ANALYZE, BUFFERS, TIMING OFF, SUMMARY OFF)
select * from redescend_test where district in (1,2,3) and warehouse > 4 and orderid > 149; -- 54 buffer hits (patch + master)
...
-- scans with these tighter inequality bounds.  At the same time we want to
-- want
--
...
insert into opfamily_test values (365), (366), (367), (8589934591), (8589934592);
