...
#define GistPageGetNSN(page) ( PageLSNToXLogRecPtr(GistPageGetOpaque(page)->nsn))
#define GistPageSetNSN(page, val) ( GistPageGetOpaque(page)->nsn = PageLSNToXLogRecPtr(val))
