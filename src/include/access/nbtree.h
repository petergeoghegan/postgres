...
typedef struct BTScanOpaqueData
{
	...
	int			npages;
	int			nwrongprecheckpages;
	int			nforcenonrequiredpages;
...
extern char *dump_scankey_strategy(ScanKey cur);
...
extern bool _bt_scanbehind_checkkeys(IndexScanDesc scan, ScanDirection dir,
									 IndexTuple finaltup);
extern void _bt_forcenonrequired(IndexScanDesc scan, BTReadPageState *pstate);
