...
typedef struct TableAmRoutine
{
	 ...
	 * process, including interfacing with the index AM. The caller simply
	 * specifies the direction of the scan; the table AM takes care of
	 * retrieving TIDs from the index, performing visibility checks, and
	 * returning tuples in the slot. This enables important optimizations
	 * (such as table block I/O prefetching) that require that the table AM
	 * directly manages the progress of the index scan.
	 */
