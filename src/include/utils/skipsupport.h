 ...
 * from the domain of indexed values.  This gives the scan a way to determine
...
typedef struct SkipSupportData
{
	 ...
	 * On the other hand, they don't have to preserve whatever semantically
	 * insignificant information the data type might be carrying around.
	 *
...
extern bool skipsupport_setup_callbacks(Oid opfamily, Oid opcintype,
