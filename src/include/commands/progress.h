...
#define PROGRESS_VACUUM_TOTAL_SCANNED_BLKS		2
#define PROGRESS_VACUUM_HEAP_BLKS_SCANNED		3
#define PROGRESS_VACUUM_HEAP_BLK_PROCESSING		4
#define PROGRESS_VACUUM_HEAP_BLKS_VACUUMED		5
#define PROGRESS_VACUUM_NUM_INDEX_VACUUMS		6
#define PROGRESS_VACUUM_MAX_DEAD_ITEMS			7
#define PROGRESS_VACUUM_NUM_DEAD_ITEMS			8
